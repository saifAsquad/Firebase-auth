...
import app from "../utils/firebase"; //Initialize the Firebase App
			...
			>
				<div className="flex justify-start items-start flex-col space-y-4">
					...
					<p className="text-sm leading-4 text-gray-500">
						...
						<a
							className="hover:underline font-bold text-gray-800 cursor-pointer"
							onClick={() => navigate("/")}
						>
							Log In
						</a>
				...
				<form className="w-full flex flex-col gap-5" onSubmit={submitHandler}>
					...
					<div className=" text-center text-md w-full">
					...
					<button
						...
						className={`py-4 w-full rounded bg-blue-700 hover:bg-blue-600 focus:bg-blue-800 text-base font-medium leading-none text-white disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-slate-600 `}
					>
						Register
					</button>
				</form>
